 ...
 * @author Theo
 */
public class CIDRJFrame extends javax.swing.JFrame {
    ...
    /**
     * Creates new form CIDRJFrame
     */
    public CIDRJFrame() throws Exception {
    ...
    private void initComponents() {
        ...
        jLabel10.setText("Mask bits:");

        jTextField6.setText("jTextField6");

        jLabel11.setText("Max Subnets:");

        jTextField7.setText("0.0.255.255");
        ...
        jLabel12.setText("Wildcard Mask");
        ...
        jMenuItem1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/iconfinder_undo-back-arrow_16px.png"))); // NOI18N
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jPanel2, javax.swing.GroupLayout.DEFAULT_SIZE, 8, Short.MAX_VALUE))
        );
...
/*------------------------------ TextField 4 Start --------------------------- */    
    ...
    private void jMenuItem3MousePressed(java.awt.event.MouseEvent evt) throws Exception {                                        
        // TODO add your handling code here:
        
        InfoIPCalc info;
        try {
            info = new InfoIPCalc( new MainJFrame ());
    ...
    private void jMenuItem1MousePressed(java.awt.event.MouseEvent evt) throws Exception {
            MainJFrame nocidr;
        try {
            
            //cidr = new CIDRJFrame(this);
            nocidr = new MainJFrame();
            nocidr.setVisible(true);
            this.setVisible(false);
            this.dispose();
        } catch (IOException ex) {
            Logger.getLogger(CIDRJFrame.class.getName()).log(Level.SEVERE, null, ex);
...
public void sliderChanged() {
    ...
    if (jSlider1.getValueIsAdjusting()){    /*Determines whether the user gesture to move the slider's knob is complete.*/
        ...
        try{   // catch exception for empty values  val_1,val_2,val_3,val_4
            ...
            jTextField7.setText(255-Integer.parseInt(v[0],2)+"."+(255-Integer.parseInt(v[1],2))+"."+(255-Integer.parseInt(v[2],2))+"."+(255-Integer.parseInt(v[3],2)));
            int[] h = Hostm1.getcalchosts();
            s_current = 0; // In CIDR this is not used
            ...
            jTextField6.setText(String.valueOf(Hostm1.getsubnetbit_cidr())); // Long integer to String
            jTextField7.setText(255-Integer.parseInt(v[0],2)+"."+(255-Integer.parseInt(v[1],2))+"."+(255-Integer.parseInt(v[2],2))+"."+(255-Integer.parseInt(v[3],2)));
...
public void field1change(){
       ...
       if ( jSlider1.getValue() <= 8 && Integer.parseInt(val_11) < 128){
               ...
               // jTextField14.setText(v[0]);
              range(Hostm,val_1,val_2,val_3,val_4);
              jLabel25.setText("A class Network");
        ...
        if (128 <= Integer.parseInt(val_11) && Integer.parseInt(val_11) < 192 && jSlider1.getValue() <= 16){
            ...
            jTextField7.setText(Integer.toString(h[0]));
            jTextField8.setText(Integer.toString(h[1]));
            jLabel25.setText("B class Network");
            jLabel25.setVisible(true);
            jSeparator4.setVisible(true);
        ...
        if (192 <= Integer.parseInt(val_11) && Integer.parseInt(val_11) < 224 && jSlider1.getValue() <= 24){
            ...
            jTextField7.setText(Integer.toString(h[0]));
            jTextField8.setText(Integer.toString(h[1]));
            jLabel25.setText("C class Network");
            jLabel25.setVisible(true);
            jSeparator4.setVisible(true);
        }
...
public void range(HostMatch b,String s1,String s2,String s3,String s4){
        ...
        String r1 = Integer.toString(v_sub.get(0))+"."+Integer.toString(v_sub.get(1))+"."+Integer.toString(v_sub.get(2))+"."+Integer.toString(v_sub.get(3));
        String r2 = Integer.toString(v_sub.get(4))+"."+Integer.toString(v_sub.get(5))+"."+Integer.toString(v_sub.get(6))+"."+Integer.toString(v_sub.get(7));
...
public void prevSub (HostMatch b,String s1,String s2,String s3,String s4){
        ...
        if (v_sub.get(3) == 0 && jSlider1.getValue() > 24){  
             val_3 = Integer.toString(Integer.parseInt(s3)-1);
             i = v_sub.get(7)- v_sub.get(3);
             val_4 = Integer.toString(256-i-1);
        }
        if (v_sub.get(2) > 0 && jSlider1.getValue() > 16 && jSlider1.getValue() <= 24){ 
            i = v_sub.get(6)- v_sub.get(2);
            val_3 = Integer.toString(Integer.parseInt(s3)-i-1);       
        }
        if (v_sub.get(2)== 0 && jSlider1.getValue() > 16){
             val_2 = Integer.toString(Integer.parseInt(s2)-1);
             i = v_sub.get(6)- v_sub.get(2);
             val_3 = Integer.toString(256-i-1);
        }
        if (v_sub.get(1) > 0 && jSlider1.getValue() > 8 && jSlider1.getValue() <= 16){ 
            i = v_sub.get(5)- v_sub.get(1);
            val_2 = Integer.toString(Integer.parseInt(s2)-i-1);       
        }
        if (v_sub.get(1)== 0 && jSlider1.getValue() > 8){
             val_1 = Integer.toString(Integer.parseInt(s1)-1);
             i = v_sub.get(5)- v_sub.get(1);
             val_2 = Integer.toString(256-i-1);
        }
        if (v_sub.get(0) > 0 && jSlider1.getValue() <= 8){ 
            i = v_sub.get(4)- v_sub.get(0);
            val_1 = Integer.toString(Integer.parseInt(s1)-i-1);       
        }
        if (v_sub.get(0) <= 0 ){ 
...
/*
public void initSecondaryComponents(MainJFrame f){
    try{
        val_1 = f.ValField1(); 
        val_2 = f.ValField2(); 
        val_3 = f.ValField3(); 
        val_4 = f.ValField4(); 
        jSlider1.setValue(f.ValSlider());
        HostMatch InitHostm = new HostMatch(val_1,val_2,val_3,val_4,f.ValSlider());
        ...
        jTextField7.setText(Integer.toString(h[0]));
        jTextField8.setText(Integer.toString(h[1]));
        s_current = f.ValSlider();
        InitHostm.setcalsubnetbits(f.ValSlider(),s_current);
...
public void initSecondaryComponents(){
    ...
    public static void main(MainJFrame frame) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                try {
                    //CIDRJFrame cidr = new CIDRJFrame(frame);
                    CIDRJFrame cidr = new CIDRJFrame();
